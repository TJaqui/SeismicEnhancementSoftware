...
def adaptSection(sec):
    ...
    elif data.shape[2]>128 and data.shape[2]<384:
        data = F.interpolate(data,(128,128),mode="bicubic")
    elif data.shape[1]>384 or data.shape[2]>384:
        data = F.interpolate(data,(int(data.shape[1]/2),int(data.shape[2]/2)),mode="bicubic")
        data = F.interpolate(data,(128,128),mode="bicubic")
